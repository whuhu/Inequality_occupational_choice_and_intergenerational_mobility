...
write.csv(IGE_diff_means_q_ci90A,"Full_Dau2_IGE_diff_means_q_ci90A.csv")
...
pval <- readRDS("C:/Users/huhu/Desktop/重构code/code/R code/Standard/R data Dau2/pval1.Rda")
print(pval)
