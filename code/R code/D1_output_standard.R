...
write.csv(IGE_diff_means_q_ci90A,"Full_Dau1_IGE_diff_means_q_ci90A.csv")

stest90 <-matrix(NaN,7,10)
...
pval <- readRDS("C:/Users/huhu/Desktop/重构code/code/R code/Standard/R data Dau1/pval1.Rda")
print(pval)
