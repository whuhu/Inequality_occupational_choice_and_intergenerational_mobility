...
write.csv(IGE_diff_means_q_ci90A,"Full_Son2_IGE_diff_means_q_ci90A.csv")

stest90 <-matrix(NaN,8,10)
...
pval <- readRDS("C:/Users/huhu/Desktop/重构code/code/R code/Standard/R data Son2/pval1.Rda")
print(pval)
