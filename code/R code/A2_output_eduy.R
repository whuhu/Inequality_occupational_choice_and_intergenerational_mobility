...
pval <- readRDS("C:/Users/huhu/Desktop/重构code/code/R code/Standard/R data A2/pval1.Rda")
print(pval)
...
coef_mat_boot_7_ciA<- gammas[,7] - t(apply((coef_mat_boot_7 - gammas[,7]),1,quantile,probs = probsA))
coef_mat_boot_8_ciA<- gammas[,8] - t(apply((coef_mat_boot_8 - gammas[,8]),1,quantile,probs = probsA))
coef_mat_boot_9_ciA<- gammas[,9] - t(apply((coef_mat_boot_9 - gammas[,9]),1,quantile,probs = probsA))
...
temp <- temp[order(temp[,1]),]
matplot(temp[floor(1+n*trim_low):floor(n-n*trim_up),1],temp[floor(1+n*trim_low):floor(n-n*trim_up),2:5],type="llll",lty=c(2,1,3,3),pch=1, col = c(3,1,2,2), xlab="Parents' Income", ylab="Coef of Parent's Log income")
temp <-0
temp <-cbind(z_dat,rep(lm_model_coef[3],n),gammas[,3],coef_mat_boot_3_ci[,1],coef_mat_boot_3_ci[,2])
temp <- temp[order(temp[,1]),]
matplot(temp[floor(1+n*trim_low):floor(n-n*trim_up),1],temp[floor(1+n*trim_low):floor(n-n*trim_up),2:5],type="llll",lty=c(2,1,3,3),pch=1, col = c(3,1,2,2), xlab="Parents' Income", ylab="Child's Education(year)")
temp <-0
...
temp <- temp[order(temp[,1]),]
matplot(temp[floor(1+n*trim_low):floor(n-n*trim_up),1],temp[floor(1+n*trim_low):floor(n-n*trim_up),2:5],type="llll",lty=c(2,1,3,3),pch=1, col = c(3,1,2,2), xlab="Parents' Income", ylab="Child's Gender")
temp <-0
temp <-cbind(z_dat,rep(lm_model_coef[6],n),gammas[,6],coef_mat_boot_6_ci[,1],coef_mat_boot_6_ci[,2])
temp <- temp[order(temp[,1]),]
matplot(temp[floor(1+n*trim_low):floor(n-n*trim_up),1],temp[floor(1+n*trim_low):floor(n-n*trim_up),2:5],type="llll",lty=c(2,1,3,3),pch=1, col = c(3,1,2,2), xlab="Parents' Income", ylab="Urban")
temp <-0
temp <-cbind(z_dat,rep(lm_model_coef[7],n),gammas[,7],coef_mat_boot_7_ci[,1],coef_mat_boot_7_ci[,2])
temp <- temp[order(temp[,1]),]
matplot(temp[floor(1+n*trim_low):floor(n-n*trim_up),1],temp[floor(1+n*trim_low):floor(n-n*trim_up),2:5],type="llll",lty=c(2,1,3,3),pch=1, col = c(3,1,2,2), xlab="Parents' Income", ylab="Minzu")
temp <-0
temp <-cbind(z_dat,rep(lm_model_coef[8],n),gammas[,8],coef_mat_boot_8_ci[,1],coef_mat_boot_8_ci[,2])
temp <- temp[order(temp[,1]),]
matplot(temp[floor(1+n*trim_low):floor(n-n*trim_up),1],temp[floor(1+n*trim_low):floor(n-n*trim_up),2:5],type="llll",lty=c(2,1,3,3),pch=1, col = c(3,1,2,2), xlab="Parents' Income", ylab="Mid")
temp <-0
temp <-cbind(z_dat,rep(lm_model_coef[9],n),gammas[,9],coef_mat_boot_9_ci[,1],coef_mat_boot_9_ci[,2])
temp <- temp[order(temp[,1]),]
matplot(temp[floor(1+n*trim_low):floor(n-n*trim_up),1],temp[floor(1+n*trim_low):floor(n-n*trim_up),2:5],type="llll",lty=c(2,1,3,3),pch=1, col = c(3,1,2,2), xlab="Parents' Income", ylab="East")
dev.off()
...
temp <-cbind(z_dat,rep(lm_model_coef[2],n),gammas[,2],coef_mat_boot_2_ci[,1],coef_mat_boot_2_ci[,2])
temp <- temp[order(temp[,1]),]
matplot(temp[floor(1+n*trim_low):floor(n-n*trim_up),1],temp[floor(1+n*trim_low):floor(n-n*trim_up),2:5],type="llll",lty=c(2,1,3,3),pch=1, col = c(3,1,2,2), xlab="Parents' Income", ylab="Coef of Parent's Logincome")
dev.off()
